 ...
 */
public class TextFilterComponentAccounts extends AbstractMatcherEditor implements FilterComponent<DataMainItem> {

    private static final TextFilterator<DataMainItem> ISSUE_TEXT_FILTERATOR = new FilteratorDMAccounts();
    ...
    public TextFilterComponentAccounts(final DockingContainer container) {
