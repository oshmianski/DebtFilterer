 ...
 */
public class RangeMatcherEditorSumDebtBegin extends RangeMatcherEditor implements FilterComponent<DataMainItem> {

    private JTextField filterFrom = new JTextField();
    private JTextField filterTo = new JTextField();

    private DockingContainer container;

    private JPanel panel;

    public RangeMatcherEditorSumDebtBegin(FilteratorDMSumDebtBegin filteratorDMSumDebt, final DockingContainer container) {
        super(filteratorDMSumDebt);
