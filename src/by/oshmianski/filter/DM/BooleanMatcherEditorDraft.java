 ...
 */
public class BooleanMatcherEditorDraft extends AbstractMatcherEditor implements FilterComponent<DataMainItem> {

    private JCheckBox excludeDraft = new JCheckBox("исключить черновики");
    ...
    private FilteratorDMDraft filteratorDMDraft;

    public BooleanMatcherEditorDraft(FilteratorDMDraft filteratorDMDraft, final DockingContainer container) {
        this.container = container;
        this.filteratorDMDraft = filteratorDMDraft;
    ...
    private void editorValueChanged(ChangeEvent e) {
        ...
        if (!editorValue) {
            ...
            final BooleanMatcher newMatcher = new BooleanMatcher(filteratorDMDraft); //put filterator !!!
