 ...
 */
public class RangeMatcherEditorSumDebt extends RangeMatcherEditor implements FilterComponent<DataMainItem> {
    ...
    public RangeMatcherEditorSumDebt(FilteratorDMSumDebt filteratorDMSumDebt, final DockingContainer container) {
