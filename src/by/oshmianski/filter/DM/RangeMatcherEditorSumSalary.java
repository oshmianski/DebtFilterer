 ...
 */
public class RangeMatcherEditorSumSalary extends RangeMatcherEditor implements FilterComponent<DataMainItem> {
    ...
    public RangeMatcherEditorSumSalary(FilteratorDMSumSalary filteratorDMSumSalary, final DockingContainer container) {
