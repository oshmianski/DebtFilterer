 ...
 */
public class BooleanMatcherEditorNumbered extends AbstractMatcherEditor implements FilterComponent<DataMainItem> {

    private JCheckBox excludeDraft = new JCheckBox("исключить пронумерованные");
    ...
    private FilteratorDMNumbered filteratorDMNumbered;

    public BooleanMatcherEditorNumbered(FilteratorDMNumbered filteratorDMNumbered, final DockingContainer container) {
        this.container = container;
        this.filteratorDMNumbered = filteratorDMNumbered;
    ...
    private void editorValueChanged(ChangeEvent e) {
        ...
        if (!editorValue) {
            ...
            final BooleanMatcher newMatcher = new BooleanMatcher(filteratorDMNumbered); //put filterator !!!
