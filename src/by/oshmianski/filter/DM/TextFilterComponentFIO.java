 ...
 */
public class TextFilterComponentFIO extends AbstractMatcherEditor implements FilterComponent<DataMainItem> {

    private static final TextFilterator<DataMainItem> ISSUE_TEXT_FILTERATOR = new FilteratorDMFIO();
    ...
    public TextFilterComponentFIO(final DockingContainer container) {
